...
- Permit Issuing / Control of Work first slice with permit request, guided page-based form, permit board, independent PTW numbering, approve / issue / suspend / extend / close lifecycle, activity history, audit trail, My Work visibility, and reporter isolation
...
- Expand Permit Issuing / Control of Work with configurable permit types, multi-role signatures, competency checks, document checks, conflict checks, QR/mobile field acknowledgement, and shift handover.
